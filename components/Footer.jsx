    ...
    <div className='bg-black  bottom-0 gap-3  flex flex-col  items-center justify-center xl:px-[15vw] p-3  lg:min-h-[5vh] min-h-[10vh]  py-5  w-full font-mont  backdrop-blur-sm relative  '>
      ...
      <div className="flex w-full xl:justify-center justify-evenly pb-4 xl:gap-28 gap-2 border-b border-white/50">
        ...
        <div className=" flex flex-col  items-start font-normal   relative nav-right transition-all duration-500 text-sm text-white/90">
          ...
          <h1 className={` font-semibold mb-2`}>Arete AI</h1>
          <Link href={'/'} className={` duration-200 hover:text-[#00a6a6] cursor-pointer `} ><h1>Home</h1></Link>
          ...
          {user && <>
            ...
            <Link href={`/profile/${user?.username}`} className={` duration-200 hover:text-[#00a6a6] cursor-pointer `} ><h1>Your Profile</h1></Link>
          </>}
      ...
      <div className=" flex  items-center gap-5 font-normal  relative nav-right transition-all duration-500  text-white/90 mt-2 text-2xl">
        ...
        <Link href={'https://www.facebook.com/devanshbhardwajdb'} target='_blank' className={` duration-200 hover:text-[#00a6a6] cursor-pointer `} ><FaFacebookF />
        </Link>

        <Link href={'https://www.linkedin.com/in/devanshbhardwajdb'} target='_blank' className={` duration-200 hover:text-[#00a6a6] cursor-pointer `} ><FaXTwitter />
        </Link>

        <Link href={'https://www.linkedin.com/in/devanshbhardwajdb'} target='_blank' className={` duration-200 hover:text-[#00a6a6] cursor-pointer `} ><FaLinkedin /></Link>

        <Link href={'https://www.instagram.com/devanshbhardwaj_db'} target='_blank' className={` duration-200 hover:text-[#00a6a6] cursor-pointer `} ><FaInstagram />
        </Link>
      </div>
